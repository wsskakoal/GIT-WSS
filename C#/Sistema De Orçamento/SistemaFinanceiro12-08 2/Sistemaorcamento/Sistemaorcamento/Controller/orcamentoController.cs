...
namespace Sistemaorcamento.Controller
{
    class orcamentoController
    {
        ...
        public void Editar(Orcamento dado)
        {
            ...
            {
                con.AbrirConexao();
                sql = new MySqlCommand("UPDATE orcamentos SET numero_orcamento = @orcamento, " +
                    "id_produto = @idproduto, " +
                    "id_cliente = @idcliente, " +
                    "quantidade = @quantidade, " +
                    "valor_total = @valortotal, " +
                    "data = @data WHERE id_orcamento = @id", con.con);
        ...
        public DataTable Buscar(Orcamento dado)
        {
            try
            {
                ...
                sql.Parameters.AddWithValue("@orcamento", dado.Id_orcamento + "%");
