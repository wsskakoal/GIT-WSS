...
namespace Sistemaorcamento.Controller
{
    public class produtoController
    {
        ...
        public DataTable ListarNormal()
        {
            try
            {
                con.AbrirConexao();
                sql = new MySqlCommand("SELECT * FROM produtos ORDER BY id_produto desc", con.con);
                MySqlDataAdapter da = new MySqlDataAdapter();
                da.SelectCommand = sql;
                DataTable dt = new DataTable();
                da.Fill(dt);
        ...
        public DataTable ListarValor(Produtos dado)
        {
            try
            {
                con.AbrirConexao();
                sql = new MySqlCommand("SELECT valor FROM Produtos WHERE id_produto like @id", con.con);
                sql.Parameters.AddWithValue("@id", dado.Id_produto);
