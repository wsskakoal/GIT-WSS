...
<div class="wrapper">
  ...
  <!-- search form -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pesquisaprodutos.php"><i class="fa fa-circle-o"></i> Cadastro De Produto</a></li>
            <li><a href="pesquisaprodutos.php"><i class="fa fa-circle-o"></i> Cadastro De Cliente</a></li>
            <li><a href="pesquisaprodutos.php"><i class="fa fa-circle-o"></i> Cadastro De Fornecedor</a></li>
            <li><a href="pesquisaclientes.php"><i class="fa fa-circle-o"></i> Cadastro De Administrador</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pesquisaclientes.php"><i class="fa fa-circle-o"></i>Entrada De Produto</a></li>
            <li><a href="pesquisafornecedores.php"><i class="fa fa-circle-o"></i>Saida De Produto</a></li>
          </ul>
        </li>
        <li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="cadastroprodutos.html" class="small-box-footer">Cadastro De Produtos<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="saiproduto.html" class="small-box-footer">Cadastro De Administrador<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="cadclient.html" class="small-box-footer">Cadastro De Clientes<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="cadfornecedor.html" class="small-box-footer">Cadastro De Fornecedores<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
      ...
      <div class="box bg-blue align-items-center">
          <div class="principal">
