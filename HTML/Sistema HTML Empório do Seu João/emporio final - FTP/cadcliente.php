            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="caadproduto.php"><i class="fa fa-circle-o"></i> Cadastro De Produto</a></li>
                            <li class="active"><a href="cadcliente.php"><i class="fa fa-circle-o"></i> Cadastro De Cliente</a></li>
            ...
            <section class="content">
                ...
                <div class="row">
                    ...
                    <!-- ./col -->
                      ...
                      <div class="principal">
                      <form name="formcadastro" action="dbcliente.php" method="POST">
