...
// Condição para verificar se a variável $dadosLogin está nulo
    if($dadosLogin == NULL)
    {
        ...
        echo "<script>window.location='painel.php';alert('O usuario $usuario foi registrado com sucesso.');</script>";

    }
    else
    {
        echo "<script>window.location='cadastrousuario.php';alert('O usuario $usuario já existe.');</script>";
    }
