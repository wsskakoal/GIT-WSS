...
<ul class="sidebar-menu" data-widget="tree">
  ...
  <li class="active treeview">
      ...
      <ul class="treeview-menu">
          ...
          <li class="active"><a href="saiproduto.php"><i class="fa fa-circle-o"></i>Saida De Produto</a></li>
      </ul>
  </li>
  <li>
...
<div class="row">
  ...
  <!-- ./col -->
                      ...
                      <div class="principal">
      <form action="dbsaiproduto.php" method="POST">
            <h1 class="border"> Saida de produto </h1>
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                <label for="inputEmail4">Data de Saida</label>
