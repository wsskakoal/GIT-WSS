...
<div class="row">
  ...
  <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-aqua">
          <div class="inner">
              <h3>Pesquisa<sup style="font-size: 20px"></sup></h3>
              <p>Pesquisa de Produtos</p>
          </div>
          <div class="icon">
              <i class="fa fa-search"></i>
          </div>
          <a href="pesquisaprodutos.php" class="small-box-footer">Pesquisa de Produtos<i class="fa fa-arrow-circle-right"></i></a>
      </div>
  </div>
  <!-- ./col -->
  <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-yellow">
          ...
          <a href="pesquisaclientes.php" class="small-box-footer">Pesquisa de Clientes<i class="fa fa-arrow-circle-right"></i></a>
      </div>
  </div>
  <!-- ./col -->
  <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-red">
          <div class="inner">
              <h3>Pesquisa<sup style="font-size: 20px"></sup></h3>
              <p>Pesquisa de Fornecedores</p>
          </div>
          <div class="icon">
              <i class="fa fa-search"></i>
          </div>
          <a href="pesquisafornecedores.php" class="small-box-footer">Pesquisa de Fornecedores<i class="fa fa-arrow-circle-right"></i></a>
      </div>
  </div>
  <!-- ./col -->
</div>
