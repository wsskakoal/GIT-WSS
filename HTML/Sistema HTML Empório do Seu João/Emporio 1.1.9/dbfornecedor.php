...
if (!$conecta) die ("<h1>Falha na coneco com o Banco de Dados!</h1>");
        ...
        if($dadoscastro == 0){
            ...
            echo "<script>alert('Fornecedor $nome cadastrado com sucesso.');window.location='cadfornecedor.php';</script>";
            }
            else
            {
            echo "<script>alert('Fornecedor $nome já existe.');window.location='cadfornecedor.php';</script>";
            }
