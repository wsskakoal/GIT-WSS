...
<ul class="sidebar-menu" data-widget="tree">
  ...
  <li class=" treeview">
      ...
      <ul class="treeview-menu">
          <li class=""><a href="painel.php"><i class="fa fa-circle-o"></i>Home</a></li>
  ...
  <li class="active treeview">
      ...
      <ul class="treeview-menu">
          ...
          <li class="active"><a href="cadusuario.php"><i class="fa fa-circle-o"></i> Cadastro De Administrador</a></li>
      </ul>
  </li>
  <li class="treeview">
      <a href="#">
            ...
            <section class="content">
                ...
                <div class="row">
                    ...
                    <!-- ./col -->
				      ...
				      <div class="box bg-green align-items-center">



                      <div class="principal">
            <div class="cadastro ">
                <form name="formcadastro" action="dbusuario.php" method="POST">
                <h1 class="border border-primary rounded"> Sistema de Cadastro de Administrador </h1>
                <br>
                <label for="nome">Cadastre um novo usuario e senha para ter acesso ao site como Adminsitrador.</label> 
                <br>
                  
                    <label class="align-baseline" for="colocarusuario"> </label> <br>
                        <div class="col-sm-5"> Usuário <br>
                            <input type="text" class="form-control" id="usuario" name="usuario" placeholder="Seu usuario">
                        </div>  
                        <label class="align-baseline" for="colocarsenha"> </label> 
                        <div class="col-sm-5"> Senha <br>
