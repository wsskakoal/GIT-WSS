...
<ul class="sidebar-menu" data-widget="tree">
  ...
  <li class="active treeview">
      ...
      <ul class="treeview-menu">
          <li class="active"><a href="entraproduto.php"><i class="fa fa-circle-o"></i>Entrada De Produto</a></li>
            ...
            <section class="content">
                ...
                <div class="row">
                    ...
                    <!-- ./col -->
				      ...
				      <div class="box bg-aqua align-items-center">




                      <div class="principal">
      <form action="dbentraproduto.php" method="POST">
        <h1 class="border"> Entrada de produto </h1>
            <div class="form-row">
              <div class="form-group col-md-6">
                <label for="inputEmail4">ID do produto</label>
                <select class="js-example-basic-single" name="state">
  <option value="AL"> <th> </option>
    ...
  <option value="WY"> <th>  </option>
</select>
